...
class TransformerService {
  public resize(
    ...
    return new Promise<Buffer>((resolve, reject) => {
      ...
      const resizedFilename = `${filenameParts[0]}_${width}_${height}.${filenameParts[1]}`;
      ...
      fs.stat(`${thumbnailsPath}/${resizedFilename}`)
        .then((stats) => {
          ...
          if (stats.isFile()) {
            ...
            fs.readFile(`${thumbnailsPath}/${resizedFilename}`).then((data) => {
            ...
            .then((data) => {
              ...
              sharp(data)
                ...
                .then(() => {
                  ...
                  return fs.writeFile(
                    `${thumbnailsPath}/${resizedFilename}`,
                    resizedImageBuffer
                  );
                })
                .then(() => {
